...
pub struct Handler {
    ...
    pending_events: VecDeque<ConnectionHandlerEvent<HandshakeOutbound, (), ToBehaviour>>,
...
pub enum ToBehaviour {
    ...
    OpenDesiredByRemote,
    CloseDesired,
    /// Response of [`FromBehavior::Close`].
    Close,
...
impl ConnectionHandler for Handler {
    ...
    type FromBehaviour = FromBehavior;
    type ToBehaviour = ToBehaviour;

    // Handle handshakes.
    type InboundProtocol = HandshakeInbound;
    ...
    fn listen_protocol(&self) -> SubstreamProtocol<Self::InboundProtocol, ()> {
        SubstreamProtocol::new(HandshakeInbound::new(self.protocol.name.clone()), ())
    }

    fn connection_keep_alive(&self) -> bool {
        !matches!(self.protocol.state, State::Closed { .. })
    }
        ...
        match &mut self.protocol.state {
            State::Open {
                ...
                Poll::Ready(Some(Ok(bytes))) => {
                    let event = ToBehaviour::Notification { bytes };
    ...
    fn on_behaviour_event(&mut self, message: FromBehavior) {
        match message {
            FromBehavior::Open => {
                ...
                match &mut self.protocol.state {
                    State::Closed { pending_opening } => {
                        if !*pending_opening {
                            let protocol = HandshakeOutbound {
                                ...
                                handshake: self.protocol.handshake.clone(),
                            };
                        ...
                        self.protocol.state = State::Opening {
                    ...
                    State::OpenDesiredByRemote {
                        ...
                        let handshake = self.protocol.handshake.clone();
            ...
            FromBehavior::Close => {
                ...
                self.pending_events
                    .push_back(ConnectionHandlerEvent::NotifyBehaviour(ToBehaviour::Close));
            }
        }
    }
    ...
    fn on_connection_event(
        ...
        match event {
            ConnectionEvent::FullyNegotiatedInbound(FullyNegotiatedInbound {
                ...
                let mut stream = protocol.substream;
                ...
                match proto.state {
                    ...
                    | State::Open {
                        ...
                        stream.set_handshake(handshake_message);
                        *inbound_substream = Some(stream);
                    }
                }
            }
            ConnectionEvent::FullyNegotiatedOutbound(outbound) => {
                let opened = outbound.protocol;
