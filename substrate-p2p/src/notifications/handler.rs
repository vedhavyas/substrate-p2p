...
pub struct Handler {
    ...
    pending_events:
        VecDeque<ConnectionHandlerEvent<HandshakeOutbound, (), NotificationsHandlerToBehavior>>,
...
impl ConnectionHandler for Handler {
        ...
        match &mut self.protocol.state {
            State::Open {
                ...
                Poll::Ready(Some(Ok(bytes))) => {
                    let event = NotificationsHandlerToBehavior::Notification { bytes };
    ...
    fn on_behaviour_event(&mut self, message: NotificationsHandlerFromBehavior) {
        match message {
            NotificationsHandlerFromBehavior::Open => {
            ...
            NotificationsHandlerFromBehavior::Close => {
